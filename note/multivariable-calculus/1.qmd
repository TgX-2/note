...
:::{.callout-warning collapse="true"}
## Chú ý
Tốc độ là $|\vec v| = \left|\frac {\mathrm d \vec r}{\mathrm d t} \right|$, thứ mà chắc chắn là không bằng với $\frac {\mathrm d |\vec r|}{\mathrm d t }$.
:::
___
# Kepler's second law
...
So $\frac {\mathrm d }{\mathrm d t}(\text{area}) = \frac 1 2 |\vec v \times \vec r|$ is constant.
...
The usual product rule can be used to differentiate vector functions: $\frac{\mathrm d}{\mathrm d t}(\vec a \cdot \vec b), \frac{\mathrm d}{\mathrm d t}(\vec a \times \vec b)$, being
careful about non-commutativity of cross-product.

$$
\frac {\mathrm d}{\mathrm d t}(\vec r \times \vec v) = \frac{\mathrm d \vec r}{\mathrm d t} \times \vec v + \vec r \times \frac{\mathrm d \vec v}{\mathrm d t} = \vec v \times \vec v + \vec r \times \vec a = \vec v \times \vec a
$$
